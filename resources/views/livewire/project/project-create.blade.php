...
<div>
    <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-lg border-2 border-gray-200">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-semibold text-gray-800">Make New Project</h2>
        </div>
        <form wire:submit.prevent="store" class="w-full">
            <div class="md:flex gap-4 lg:w-full w-full justify-center">
                <div class="w-full">
                    <div>
                ...
                {{-- <div class="w-1/2">
                    <label for="">Search (you can do it later)</label>
                    <input type="text" wire:model="search" class="w-full border-2 border-gray-400 rounded-lg p-2" placeholder="Search an assignee">
                </div> --}}
            </div>
